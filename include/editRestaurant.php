                    ...
                    <div class='col-md-offset-3 col-md-12 col-sm-offset-2 col-sm-8'>
                        <form class='form-horizontal row' method='POST' action=''>
                            <div class='form-floating col-md-6 p-3'>
                                <input type='text' name='restaurantMame' class='form-control rounded-4' value='{$value["name"]}' maxlength='60' placeholder='Password' required='true'>
                            ...
                            <div class='form-floating col-md-12 p-3'>
                                <textarea type='text' name='description'  style='height: 300px;' class='form-control rounded-4' placeholder='Password' required='true'>{$value["description"]}</textarea>
                            ...
                            <div class='form-floating col-md-3 p-3'>
                                <input type='number' name='deliveryFrom' class='form-control rounded-4' value='{$value["delivery-from"]}' placeholder='Password' required='true' min='10' max='500'>
                                <label for='deliveryFrom' class='p-4'>Delivery From</label>
                            </div>
                            <div class='form-floating col-md-3 p-3'>
                                <input type='number' name='deliveryUntil' class='form-control rounded-4' value='{$value["delivery-until"]}' placeholder='Password' required='true' min='10' max='500'>
                                <label for='deliveryUntil' class='p-4'>Delivery Until</label>
                            </div>
                            <div class='modal-footer p-5  pt-0 pb-0' style='border-top: 0 none;'>
                                <div class='col text-center '>
                                    <button class='w-50  btn btn-lg rounded-4 btn-warning btn btn-info' name='button' value='submit' type='submit'>Update Restaurant</button>
                                </div>
                            </div>
                        </form>
                    </div>
